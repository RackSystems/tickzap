...
O serviço `tickzap-ai` funcionará como um agente de IA *stateless* e *multi-tenant*. Ele receberá tickets de suporte via webhooks (por exemplo, vindos do gateway de WhatsApp ou da API principal), processará e anonimizará os dados locais para LGPD, consultará a base de conhecimento específica do cliente (*tenant*) usando vetores e responderá com a melhor ação estruturada (categoria, roteamento e satisfação).
